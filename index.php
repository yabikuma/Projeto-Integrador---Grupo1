...
<?php include 'header.php'?>
	...
	<section class="container custom-container"><!--Seção Categorias-->
	<div class="row">
		<div class="col-12 text-center my-3"> <!--Título da Seção-->
			<h2>Categorias</h2>
		</div>
	</div>
	...
	<div class="row"><!--Row Produtos-->
		<div class="col-12 col-sm-6 col-md-3 product">
			<h6>Guitarra</h6>
			<img src="img/teste1.jpg" class="img-thumbnail">	
	...
	</div><!-- Fim da Row Produtos-->
	</section><!--Fim da Categorias-->

	<section class="container custom-container"><!--Seção Promoções-->
	<div class="row">
		<div class="col-12 text-center my-3"> <!--Título da Seção-->
			<h2>Promoções</h2>
		</div>
	...
	<div class="row"><!--Row Produtos Promoção-->
		<div class="col-12 col-sm-6 col-md-3 product">
			<h6>Guitarra</h6>
	...
	</div><!-- Fim da Row Produtos Promoção-->
	</section><!--Fim da Seção Promoção-->

	<section class="container custom-container"><!--Seção Mais Vistos-->
		<div class="row">
			<div class="col-12 text-center my-3"> <!--Título da Seção-->
				<h2>Mais Vistos</h2>
			</div>
		...
		<div class="row"><!--Row Produtos Mais Vistos-->
			<div class="col-12 col-sm-6 col-md-3 product">
				<h6>Guitarra</h6>
				<img src="img/produto1.jpg" class="img-thumbnail">	
				<button type="button" class="btn btn-primary">Comprar</button>
		...
		</div><!-- Fim da Row Produtos Mais Vistos-->
		</section><!--Fim da Seção Mais Vistos-->
